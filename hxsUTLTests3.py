...
class Sutl:
    ...
    def logenter(self,msg,s,t,h):
        if (h > 0):
            ...
            haxe_Log.trace((" - s: " + HxOverrides.stringOrNull(haxe_format_JsonPrinter.print(s,None,"  "))),_hx_AnonObject({'fileName': "Sutl.hx", 'lineNumber': 541, 'className': "Sutl", 'methodName': "logenter"}))
            haxe_Log.trace((" - t: " + HxOverrides.stringOrNull(haxe_format_JsonPrinter.print(t,None,"  "))),_hx_AnonObject({'fileName': "Sutl.hx", 'lineNumber': 542, 'className': "Sutl", 'methodName': "logenter"}))
    ...
    def logexit(self,msg,r,h):
        if (h > 0):
            ...
            haxe_Log.trace((" - r: " + HxOverrides.stringOrNull(haxe_format_JsonPrinter.print(r,None,"  "))),_hx_AnonObject({'fileName': "Sutl.hx", 'lineNumber': 551, 'className': "Sutl", 'methodName': "logexit"}))
...
class TestsGet(haxe_unit_TestCase):
    ...
    def testGet1(self):
        ...
        self.assertEquals(2,Util.get(obj,"fred","zzz"),_hx_AnonObject({'fileName': "TestsGet.hx", 'lineNumber': 11, 'className': "TestsGet", 'methodName': "testGet1"}))
    ...
    def testGetDefault(self):
        ...
        self.assertEquals("zzz",Util.get(obj,"fred","zzz"),_hx_AnonObject({'fileName': "TestsGet.hx", 'lineNumber': 23, 'className': "TestsGet", 'methodName': "testGetDefault"}))

    def testGetArray(self):
        obj = haxe_ds_StringMap()
        obj = python_lib_Json.loads("[{\"fred\": 2}]",**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
        self.assertEquals("isarray",Util.get(obj,"fred","isarray"),_hx_AnonObject({'fileName': "TestsGet.hx", 'lineNumber': 35, 'className': "TestsGet", 'methodName': "testGetArray"}))
    ...
    def testGetSimple(self):
        ...
        self.assertEquals("isnumber",Util.get(obj,"fred","isnumber"),_hx_AnonObject({'fileName': "TestsGet.hx", 'lineNumber': 46, 'className': "TestsGet", 'methodName': "testGetSimple"}))
    ...
    def testGetNull(self):
        ...
        self.assertEquals("isnull",Util.get(obj,"fred","isnull"),_hx_AnonObject({'fileName': "TestsGet.hx", 'lineNumber': 57, 'className': "TestsGet", 'methodName': "testGetNull"}))
    ...
    def testGetNoDefault(self):
        ...
        self.assertEquals(None,Util.get(obj,"fred"),_hx_AnonObject({'fileName': "TestsGet.hx", 'lineNumber': 68, 'className': "TestsGet", 'methodName': "testGetNoDefault"}))
...
class Tests_Builtins(haxe_unit_TestCase):
    ...
    def callbuiltin2(self,builtinname,scope,expected):
        f = Util.get(Sutl().builtins(),builtinname)
    ...
    def callbuiltin3(self,builtinname,scope,parentscope,l,src,tt,expected):
        ...
        self.assertTrue(Util.deepEqual(expected,f(parentscope,scope,l,src,tt,None,None)),_hx_AnonObject({'fileName': "Tests_Builtins.hx", 'lineNumber': 49, 'className': "Tests_Builtins", 'methodName': "callbuiltin3"}))
...
class Tests_Decls(haxe_unit_TestCase):
    ...
    def EvaluateTransform(self,aDecl,aLibDecls,aSource = None):
        ...
        return s.evaluate(aSource,Util.get(aDecl,"transform-t"),llib,0)

    def EvaluateTransform2(self,aDecl,aLib,aSource = None):
        return Sutl().evaluate(aSource,Util.get(aDecl,"transform-t"),aLib,0)

    def testLoadCoreDist(self):
        self.assertTrue(Util.isArray(self.LoadCoreDist()),_hx_AnonObject({'fileName': "Tests_Decls.hx", 'lineNumber': 93, 'className': "Tests_Decls", 'methodName': "testLoadCoreDist"}))
...
class Tests_isType(haxe_unit_TestCase):
    ...
    def getValue(self,aTypeName):
        return Util.get(_hx_AnonObject({'object': _hx_AnonObject({'x': 1, 'y': 2}), 'array': [1, 2, "xxx"], 'string': "xxxx", 'number': 2, 'number2': 2.5, 'bool': True, 'null': None}),aTypeName)
    ...
    def testIsBuiltinEval(self):
        self.assertTrue(Util.isBuiltinEval(_hx_AnonObject({'&': "thing", 'x': 2})),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 186, 'className': "Tests_isType", 'methodName': "testIsBuiltinEval"}))

    def testIsBuiltinEval2(self):
        self.assertFalse(Util.isBuiltinEval(_hx_AnonObject({'x&': "thing", 'x': 2})),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 196, 'className': "Tests_isType", 'methodName': "testIsBuiltinEval2"}))

    def testIsArrayBuiltinEval(self):
        self.assertTrue(Util.isArrayBuiltinEval(["&+", 1, 2],Sutl().builtins()),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 211, 'className': "Tests_isType", 'methodName': "testIsArrayBuiltinEval"}))

    def testIsArrayBuiltinEval2(self):
        self.assertFalse(Util.isArrayBuiltinEval(["&foo", 1, 2],Sutl().builtins()),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 226, 'className': "Tests_isType", 'methodName': "testIsArrayBuiltinEval2"}))

    def testIsStringBuiltinEval(self):
        self.assertTrue(Util.isStringBuiltinEval("^@.x.y.z",Sutl().builtins()),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 237, 'className': "Tests_isType", 'methodName': "testIsStringBuiltinEval"}))

    def testIsStringBuiltinEval2(self):
        self.assertFalse(Util.isStringBuiltinEval("@.x.y.z",Sutl().builtins()),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 248, 'className': "Tests_isType", 'methodName': "testIsStringBuiltinEval2"}))

    def testIsStringBuiltinEval3(self):
        self.assertFalse(Util.isStringBuiltinEval("&zzz.x.y.z",Sutl().builtins()),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 259, 'className': "Tests_isType", 'methodName': "testIsStringBuiltinEval3"}))

    def testIsEval(self):
        self.assertTrue(Util.isEval(_hx_AnonObject({'!': _hx_AnonObject({'x': 1}), 'z': 2})),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 269, 'className': "Tests_isType", 'methodName': "testIsEval"}))

    def testIsEval2(self):
        self.assertTrue(Util.isEval2(_hx_AnonObject({'!!': _hx_AnonObject({'x': 1}), 's': 2})),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 279, 'className': "Tests_isType", 'methodName': "testIsEval2"}))

    def testIsQuoteEval(self):
        self.assertTrue(Util.isQuoteEval(self.quote(_hx_AnonObject({'x': 1}))),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 286, 'className': "Tests_isType", 'methodName': "testIsQuoteEval"}))

    def testIsDoubleQuoteEval(self):
        self.assertTrue(Util.isDoubleQuoteEval(self.unquote(_hx_AnonObject({'x': 1}))),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 293, 'className': "Tests_isType", 'methodName': "testIsDoubleQuoteEval"}))

    def testIsColonEval(self):
        self.assertTrue(Util.isColonEval(_hx_AnonObject({':': _hx_AnonObject({'x': 1}), 's': 2})),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 303, 'className': "Tests_isType", 'methodName': "testIsColonEval"}))

    def testIsListTransform(self):
        self.assertTrue(Util.isListTransform([1, 2, 3]),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 310, 'className': "Tests_isType", 'methodName': "testIsListTransform"}))

    def testIsDictTransform(self):
        self.assertTrue(Util.isDictTransform(_hx_AnonObject({})),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 317, 'className': "Tests_isType", 'methodName': "testIsDictTransform"}))

    def testShallowCopy(self):
        lsource = python_Boot.fields(_hx_AnonObject({'a': 1, 'b': 2}))
        self.assertTrue(Util.deepEqual(lsource,Util.shallowCopy(lsource)),_hx_AnonObject({'fileName': "Tests_isType.hx", 'lineNumber': 326, 'className': "Tests_isType", 'methodName': "testShallowCopy"}))
